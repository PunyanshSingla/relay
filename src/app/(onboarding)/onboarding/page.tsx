  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-md">
          ...
          <CardContent className="p-6">
            ...
            {status?.gmail ? (
              <div className="flex items-center gap-2 h-11 px-4 rounded-md bg-green-500/10 border border-green-500/20">
                ...
                <span className="text-sm font-medium text-green-700 dark:text-green-300">Gmail Connected</span>
        ...
        <Card className="border-border mt-4">
          <CardContent className="p-6">
            ...
            {status?.calendar ? (
              <div className="flex items-center gap-2 h-11 px-4 rounded-md bg-green-500/10 border border-green-500/20">
                <CheckCircle2 className="size-4 text-green-600 dark:text-green-400" />
                <span className="text-sm font-medium text-green-700 dark:text-green-300">Calendar Connected</span>
                <Badge variant="secondary" className="ml-auto text-xs bg-green-500/10 text-green-700 dark:text-green-300 border-0">
                  Ready
                </Badge>
              </div>
        ...
        {/* Skip link when only one connected */}
        {!bothConnected && status?.gmail && (
