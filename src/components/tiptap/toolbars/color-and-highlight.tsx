...
const ColorHighlightButton = ({
	...
	<button
		...
		className="flex w-full items-center justify-between rounded-sm px-2 py-1 text-sm cursor-pointer hover:bg-gray-3"
		type="button"
	>
...
export const ColorHighlightToolbar = () => {
	...
	const handleSetColor = (color: string) => {
		if (color === "var(--editor-text-default)" || color === currentColor) {
	...
	const handleSetHighlight = (color: string) => {
		if (color === "var(--editor-highlight-default)" || color === currentHighlight) {
