...
> For a complete documentation index, see https://openrouter.ai/docs/agent-sdk/overview/llms.txt.
> For AI client integration (Claude Code, Cursor, etc.), connect to the MCP server at https://openrouter.ai/docs/agent-sdk/overview/_mcp/server.
